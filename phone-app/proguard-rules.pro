...
-keep,includedescriptorclasses class com.fxMedia.annotatePhone.**$$serializer { *; }
-keepclassmembers class com.fxMedia.annotatePhone.** {
    *** Companion;
}
-keepclasseswithmembers class com.fxMedia.annotatePhone.** {
    kotlinx.serialization.KSerializer serializer(...);
}
