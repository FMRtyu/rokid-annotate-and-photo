package com.fxMedia.annotatePhone.service.stt
...
private class GeminiSttAdapter(
    ...
    private val geminiService by lazy {
        com.fxMedia.annotatePhone.service.ai.GeminiService(apiKey, modelId)
    }
    
    override val provider = SttProvider.GEMINI
    
    override suspend fun transcribe(audioData: ByteArray, languageCode: String): com.fxMedia.annotatePhone.service.SpeechResult {
...
private class OpenAiWhisperSttAdapter(
    ...
    private val openAiService by lazy {
        com.fxMedia.annotatePhone.service.ai.OpenAiCompatibleService(
            apiKey = apiKey,
            baseUrl = com.fxMedia.annotatePhone.data.AiProvider.OPENAI.defaultBaseUrl,
            modelId = "gpt-5.1",
            providerType = com.fxMedia.annotatePhone.data.AiProvider.OPENAI
        )
    }
...
private class GroqWhisperSttAdapter(
    ...
    private val groqService by lazy {
        com.fxMedia.annotatePhone.service.ai.OpenAiCompatibleService(
            apiKey = apiKey,
            baseUrl = com.fxMedia.annotatePhone.data.AiProvider.GROQ.defaultBaseUrl,
            modelId = "llama-4-70b-versatile",
            providerType = com.fxMedia.annotatePhone.data.AiProvider.GROQ
        )
    }
