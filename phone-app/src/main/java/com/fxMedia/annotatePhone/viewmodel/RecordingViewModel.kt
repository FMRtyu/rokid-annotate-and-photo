...
import com.fxMedia.annotatePhone.data.db.*
import com.fxMedia.annotatePhone.service.EnhancedAIService
    ...
    fun transcribeRecording(id: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                com.fxMedia.annotatePhone.service.ServiceBridge.requestTranscribeRecording(id, recording.filePath)
