package com.fxMedia.annotatePhone.service.ai

import com.fxMedia.annotatePhone.service.SpeechResult
import com.fxMedia.annotatePhone.testutil.MockWebServerRule
import com.fxMedia.annotatePhone.testutil.TestFixtures
...
class AnthropicServiceTest {
    ...
    fun `provider returns ANTHROPIC`() {
        val service = createService()
        assertThat(service.provider).isEqualTo(com.fxMedia.annotatePhone.data.AiProvider.ANTHROPIC)
    }
